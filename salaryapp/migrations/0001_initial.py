    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Admin', 'Admin'), ('HR', 'HR')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='salaryapp.employee')),
            ],
        ),
        migrations.CreateModel(
            name='Leave',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='salaryapp.salary')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='salaryapp.employee')),
            ],
        ),
    ]
